...
public class FightingUtil {
    ...
    private static Logger logger= LoggerFactory.getLogger(FightingUtil.class);
     ...
     * @param stepDetail
     */
    public static void generateFightingStep(Combatant peerA, Combatant peerB, int sp, int actId, boolean bj, int mode, Integer hurtCount,FightStepDetailVO stepDetail,Object ... args){
                        ...
                        switch (mode){
                                ...
                                case 3:
                                    ...
                                    if(actId==SkillConstant.SKILL_10){
                                        ...
                                        lostWeapon.put("weaponIdList",args[0]);
                        ...
                        switch (mode){
                            case 3:
                                ...
                                if(actId==SkillConstant.SKILL_19){
                                    ...
                                    buffMap2.put("amount",1);
                                    stepDetail.setBuff(buffMap2);
                                    FightingUtil.dealAddBlood(peerA,peerA.getAddBloodCountRecord()==null?0:peerA.getAddBloodCountRecord(),stepDetail);
                                }
    ...
    public static  List<UserSkillVO> findUserSkillByBuffIds(Combatant combatant,Map<Integer,Integer> skillIds){
        ...
        skillVOList.forEach(skill->{
            if(skillIds.containsKey(skill.getSkillId()) && (skill.getFreezeCount()==null ||skill.getFreezeCount()==0) && skill.getCanUse()){
                result.add(skill);
            }
        });
        return result;
