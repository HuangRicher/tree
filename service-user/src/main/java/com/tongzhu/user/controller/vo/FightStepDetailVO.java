...
public class FightStepDetailVO implements Serializable {
    ...
    private Map<String,Object> bloodCount; //生命值回复；

    private Map<String,Object> addBlood; //立即回复生命值；
    ...
    private List<Map<String,Object>> deadPlayerList;

    private List<String> weaponIdList;

    private Map<String,Object> lostWeapon;

    private Integer category; //类别  1：闪避   2：格挡

    private List<Map<String,String>> weaponList;  //丢弃的武器ID列表

    private Integer selfFuryValue;//己方怒气值

    private Integer opponentFuryValue;//对方怒气值

    private Integer selfBlood;//己方血量值

    private Integer opponentBlood;//对方血量值

    private List<Map<String,Object>> toxicosisCountList;
    ...
    public Map<String, Object> getAddBlood() {
        return addBlood;
    }

    public void setAddBlood(Map<String, Object> addBlood) {
    ...
    public List<Map<String, Object>> getDeadPlayerList() {
        return deadPlayerList;
    }

    public void setDeadPlayerList(List<Map<String, Object>> deadPlayerList) {
        this.deadPlayerList = deadPlayerList;
    }

    public List<Map<String, Object>> getToxicosisCountList() {
        return toxicosisCountList;
    }

    public void setToxicosisCountList(List<Map<String, Object>> toxicosisCountList) {
        this.toxicosisCountList = toxicosisCountList;
    }

    public Map<String, Object> getLostWeapon() {
        return lostWeapon;
    }

    public void setLostWeapon(Map<String, Object> lostWeapon) {
